...
enum camcorder_quality {
    ...
    CAMCORDER_QUALITY_MTK_720P_240                  = 2243,
...
#if defined(MTK_AOSP_ENHANCEMENT) || defined(MTK_EMULATOR_SUPPORT)
    CAMCORDER_QUALITY_MTK_CAM_FEATURE_LIST_START = 3100,
    CAMCORDER_QUALITY_MTK_VSDOF_MEDIUM = 3101,
    CAMCORDER_QUALITY_MTK_VSDOF_HIGH = 3102,
    CAMCORDER_QUALITY_MTK_CAM_FEATURE_LIST_END = 3102,
#endif
};
...
private:
    ...
    static void createMTKVSDOFCamcorderProfiles(MediaProfiles *profiles);
