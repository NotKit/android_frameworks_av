...
const MediaProfiles::NameToTagMap MediaProfiles::sCamcorderQualityNameMap[] = {
    ...
    {"mtkvsdofmedium", CAMCORDER_QUALITY_MTK_VSDOF_MEDIUM},
    {"mtkvsdofhigh", CAMCORDER_QUALITY_MTK_VSDOF_HIGH},
...
static bool isMtkCamFeatureProfile(camcorder_quality quality) {
    return quality >= CAMCORDER_QUALITY_MTK_CAM_FEATURE_LIST_START &&
...
void MediaProfiles::checkAndAddRequiredProfilesIfNecessary() {
    ...
    for (size_t i = 0, n = mCamcorderProfiles.size(); i < n; ++i) {
        ...
        } else if (isHighSpeedProfile(quality) || isMtkCamFeatureProfile(quality)) {
...
MediaProfiles::createMTKCamcorderProfile(camcorder_quality quality, camcorder_mode CamMode, camera_id CamId)
{
    ...
    switch(quality)
    {
        ...
        case CAMCORDER_QUALITY_MTK_1080P_120:
            ...
            break;
        case CAMCORDER_QUALITY_MTK_VSDOF_MEDIUM:
            videoCodec = new MediaProfiles::VideoCodec(VIDEO_ENCODER_H264, 12750*1000, 1440, 1080, 30);
            break;
        case CAMCORDER_QUALITY_MTK_VSDOF_HIGH:
            videoCodec = new MediaProfiles::VideoCodec(VIDEO_ENCODER_H264, 17000*1000, 1920, 1080, 30);
            break;
        default:
...
MediaProfiles::createMTKCamcorderProfiles(MediaProfiles *profiles)
{
    ...
    createMTKVSDOFCamcorderProfiles(profiles);
...
/*static*/ void
MediaProfiles::createMTKVSDOFCamcorderProfiles(MediaProfiles *profiles)
{
    ...
    switch(eChipName)
    {
        case VAL_CHIP_NAME_MT6797:
            {
                //CAMCORDER_QUALITY_MTK_VSDOF_MEDIUM
                MediaProfiles::CamcorderProfile *VSDOFMedium=
                    createMTKCamcorderProfile(CAMCORDER_QUALITY_MTK_VSDOF_MEDIUM, CAMCORDER_DAY_MODE, BACK_CAMERA);
                profiles->mCamcorderProfiles.add(VSDOFMedium);
                //CAMCORDER_QUALITY_MTK_VSDOF_HIGH
                MediaProfiles::CamcorderProfile *VSDOFHigh=
                    createMTKCamcorderProfile(CAMCORDER_QUALITY_MTK_VSDOF_HIGH, CAMCORDER_DAY_MODE, BACK_CAMERA);
                profiles->mCamcorderProfiles.add(VSDOFHigh);
            }
            break;
        default:
            break;
    }
#else//no MTK_CAM_VSDOF_SUPPORT
    UNUSEDP(profiles);
