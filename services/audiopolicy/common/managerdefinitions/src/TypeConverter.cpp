...
#ifdef MTK_AUDIO
        MAKE_STRING_FROM_ENUM(AUDIO_DEVICE_IN_MATV),
#endif
...
#ifdef MTK_AUDIO
    MAKE_STRING_FROM_ENUM(AUDIO_CHANNEL_IN_VOICE_UPLINK),
    MAKE_STRING_FROM_ENUM(AUDIO_CHANNEL_IN_VOICE_DNLINK),
    // MAKE_STRING_FROM_ENUM(AUDIO_CHANNEL_IN_VOICE_MIX)
#endif
};
template<>
